    ...
    <Grid container spacing={3} sx={{ mb: 3 }}>
        ...
        <Card elevation={3} sx={{ p: 2 }}>
          <ContentBox>
            <FabIcon size="medium" sx={{ background: bgError, overflow: 'hidden' }}>
              <Icon sx={{ color: textError }}>monetization_on</Icon>
            </FabIcon>
            <H3 textcolor={textError}>Sells</H3>
          </ContentBox>
      ...
      <Grid item xs={12} md={6}>
        <Card elevation={3} sx={{ p: 2 }}>
          <ContentBox>
            ...
            <H3 textcolor={textError}>Restocks</H3>
          </ContentBox>
      ...
      <Grid item xs={12} md={6}>
        <Card elevation={3} sx={{ p: 2 }}>
          <ContentBox>
            <FabIcon size="medium" sx={{ background: bgError, overflow: 'hidden' }}>
              <Icon sx={{ color: textError }}>menu</Icon>
            </FabIcon>
            <H3 textcolor={textError}>All Transactions</H3>
          </ContentBox>
